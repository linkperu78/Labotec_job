...
public class MyRvAdapter extends RecyclerView.Adapter<MyRvAdapter.ViewHolder>{
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!selectedFile.isDirectory()){
                    ...
                    guardar_dato_cache("file_path",selectedFile.getAbsolutePath());
                    //Log.d("AS", "onClick: " + selectedFile.getParent());
                    guardar_dato_cache("folder_path",selectedFile.getParent());
    ...
    public void guardar_dato_cache(String key, String data){
        SharedPreferences preferences = context.getSharedPreferences("URL_database", Context.MODE_PRIVATE);
